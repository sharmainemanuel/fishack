...
$.ajax({
            ...
            success: function(result){                          
				for (var i = 1; i < 5; i++) {
					...
					$("#showDaily").append("<div class='	col-md-3 col-xs-3'><div class='classWithPad'>"+daily+"<br><img width='100%' class='wIcon' src='http://openweathermap.org/img/w/"+ icon  + ".png'><strong>"+max + "&deg; </strong><br>" +min+"&deg;<br><br></div></div>");   
